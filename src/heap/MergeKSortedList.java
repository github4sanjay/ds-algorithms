...
public class MergeKSortedList {
    ...
    public static ArrayList<Integer> merge(List<List<Integer>> lists){
        PriorityQueue<Holder> holders = new PriorityQueue<>(new Comparator<Holder>() {
            @Override
        ...
        for (int i=0;i<lists.size();i++){
            holders.add(
                    new Holder(i, 0, lists.get(i).get(0))
            );
        }
    ...
    public static void main(String[] args) {
        System.out.println(MergeKSortedList.merge(List.of(List.of(1,4,5), List.of(1,3,4),List.of(2,6))));
    }
}
