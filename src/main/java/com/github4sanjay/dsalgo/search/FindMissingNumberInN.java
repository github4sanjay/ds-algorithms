 ...
 * find the missing integer. Example:
 *
 * <p>Input: arr[] = {1, 2, 4, 6, 3, 7, 8} Output: 5 Explanation: The missing number from 1 to 8 is
 * 5
 *
 * <p>Input: arr[] = {1, 2, 3, 5} Output: 4 Explanation: The missing number from 1 to 5 is 4
 */
