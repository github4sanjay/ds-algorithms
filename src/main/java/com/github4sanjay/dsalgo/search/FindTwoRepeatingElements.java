 ...
 * elements occur once except two numbers which occur twice. Find the two repeating numbers. For
 * example, array = {4, 2, 4, 5, 2, 3, 1} and n = 5
 *
 * <p>The above array has n + 2 = 7 elements with all elements occurring once except 2 and 4 which
