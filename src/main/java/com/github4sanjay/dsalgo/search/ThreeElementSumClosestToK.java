...
/**
 * Given an array arr[] of N integers and an integer X, the task is to find three integers in arr[]
 * such that the sum is closest to X. Examples:
 *
 * <p>Input: arr[] = {-1, 2, 1, -4}, X = 1 Output: 2 Explanation: Sums of triplets: (-1) + 2 + 1 = 2
 * (-1) + 2 + (-4) = -3 2 + 1 + (-4) = -1 2 is closest to 1.
 *
 * <p>Input: arr[] = {1, 2, 3, 4, -5}, X = 10 Output: 9 Explanation: Sums of triplets: 1 + 2 + 3 = 6
 * 2 + 3 + 4 = 9 1 + 3 + 4 = 7 ... 9 is closest to 10.
 */
