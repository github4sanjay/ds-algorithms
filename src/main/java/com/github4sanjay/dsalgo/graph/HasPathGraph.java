...
public class HasPathGraph {
  ...
  /**
   * if source and destination are equal then return true other wise check in all neighbour with the
   * source = neighbour and same destination
   */
