...
public class SmallestPathGraph {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        SmallestPathGraph.findPath(graph, 0, 6)); // Answer{path=[0, 1, 2, 5, 6], weight=28}
  }

  /**
   * if source and destination are equal then check if current weight is less than previous path
