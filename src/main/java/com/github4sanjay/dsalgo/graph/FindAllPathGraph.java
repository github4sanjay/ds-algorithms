...
public class FindAllPathGraph {
  ...
  /**
   * if source and destination are equal then add current path to final list other wise check in all
   * neighbour with the source = neighbour and same destination
   */
  public static List<List<Integer>> findPath(
      int[][] array, int vertices, int vertex1, int vertex2) {
