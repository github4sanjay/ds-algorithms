...
public class IsCyclic {
   ...
   * <p>4----------5 \ / \ / \ / 6
   *
   * <p>When loop reaches vertex 4 : then 4 either go 5 or 6 first: if chooses 5 first then path
   * would 4---5---6 then stop then it start for 6 but since six already visited so there are two
   * paths to 6 from 4 so cyclic
   */
  ...
  public static class Pair {
    ...
    public String toString() {
      return "Pair{" + "vertex=" + vertex + ", pathSoFar=" + pathSoFar + '}';
    }
  }
}
