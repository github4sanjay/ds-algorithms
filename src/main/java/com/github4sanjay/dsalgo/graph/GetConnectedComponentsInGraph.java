...
/**
 * Given an undirected graph, print all connected components line by line. For example consider the
 * following graph.
 *
 * <p>Example 1 : [[0, 1], [2, 3], [4, 5, 6]]
 *
 * <p>0---1 2---3 4---5---6 |______|
 *
 * <p>Example 2 : [[0, 1, 2, 3], [4, 6, 7], [5], [8, 9]]
 *
 * <p>0---1---2---3 4---6---7 5 8---9
 */
public class GetConnectedComponentsInGraph {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        GetConnectedComponentsInGraph.get(
            new Graph(
                new int[][] {
                  {0, 1, 10},
                  {1, 2, 10},
  ...
  /**
   * Find for all vertices all connected vertices and keep track of visited if vertex already
   * visited dont visit again
   */
  ...
  private static void getComponent(
      Graph graph, int src, boolean[] visited, List<Integer> components) {
