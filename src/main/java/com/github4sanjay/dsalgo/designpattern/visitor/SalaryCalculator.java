...
public class SalaryCalculator implements Visitor<Integer> {
  ...
  public Integer visit(CommissionBasedEmployee commissionBasedEmployee) {
    return commissionBasedEmployee.getProfit()
        * commissionBasedEmployee.getCommissionPercent()
        / 100;
  }

  @Override
  public Integer visit(
      FixedSalaryAndCommissionBasedEmployee fixedSalaryAndCommissionBasedEmployee) {
    return fixedSalaryAndCommissionBasedEmployee.getSalary()
        + fixedSalaryAndCommissionBasedEmployee.getProfit()
            * fixedSalaryAndCommissionBasedEmployee.getCommissionPercent()
            / 100;
  }
}
