...
public class FindAllPathToRightBottom {
  public static void main(String[] args) {
    ...
    /**
     * Output: rdddrrdr rdddrrrd rddrdrdr rddrdrrd rdrdldrrdr rdrdldrrrd rdrddrdr rdrddrrd
     * rrdlddrrdr rrdlddrrrd rrdldrdrdr rrdldrdrrd rrddldrrdr rrddldrrrd rrdddrdr rrdddrrd
     */
