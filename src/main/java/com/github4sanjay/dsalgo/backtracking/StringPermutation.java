...
public class StringPermutation {
  ...
  public static void main(String[] args) {
    System.out.println(
        StringPermutation.findWithCombination("aabb")); // [aabb, abab, abba, baab, baba, bbaa]
    System.out.println(
        StringPermutation.findWithPermutation("aabb")); // [aabb, abab, abba, baab, baba, bbaa]
  }
  ...
  private static void findWithCombination(
  ...
  private static void findWithPermutation(
      String str,
      HashMap<Character, Integer> lastOccurredAt,
