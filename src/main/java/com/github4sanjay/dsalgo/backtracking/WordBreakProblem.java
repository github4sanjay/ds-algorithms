...
public class WordBreakProblem {
  ...
  public static void main(String[] args) {
    ...
    /** micro soft hi ring micro soft hiring microsoft hi ring microsoft hiring */
    WordBreakProblem.findSentences(
        "microsofthiring", new String[] {"micro", "soft", "hi", "ring", "microsoft", "hiring"});

    /** i like sam sung i like samsung */
    WordBreakProblem.findSentences(
        "ilikesamsung",
        new String[] {
          "i",
