...
public class MinimumScoreOfTriangulation {
   ...
   *
   *
   *  b __________ c                b __________ c           b __________ c
   *   |         |                   |       .'|              |         |      join bd
   *   |         |     --------->    |  . '    |              |         |
   * a |_________|d                a |'________|d           a |_________|d
   *    keep ab
   *    as base        abcd  =      adc + cd + abc             abd + ab + bcd
   *
   * Always keep first and last vertices as base and then look how many variations are possible.
   *
   *                       |     a   |     b   |     c    |    d    |      e   |
   *                   ____|_________|_________|__________|_________|__________|
   *      a             a  |    0    |     0   |    abc   |  abcd   |   abcde  |
   *     /\            ____|_________|_________|__________|_________|__________|
   *  e /  \ b          b  |    x    |     0   |     0    |   bcd   |   bcde   |
   *   |   |           ____|_________|_________|__________|_________|__________|
   * d |___| c          c  |    x    |     x   |     0    |    0    |     cde  |
   *    ae             ____|_________|_________|__________|_________|__________|
   * as base            d  |    x    |    x    |    x     |    0    |      0   |
   *                   ____|_________|_________|__________|_________|__________|
   *                    e  |    x    |    x    |    x     |   x     |      0   |
   *                   ____|_________|_________|__________|_________|__________|
   *
   *                   abcde = max {abe + ab + bcde, ace + abc + cde, ade + abcd + ce}
   *                   Here abe, ace, ade will come from vertices values and rest from DP
   *
   *
   */
