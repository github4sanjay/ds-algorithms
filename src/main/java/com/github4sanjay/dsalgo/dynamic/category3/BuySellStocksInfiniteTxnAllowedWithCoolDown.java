 ...
 * you can make if you are allowed infinite transactions, but have to cooldown for 1 day after 1
 * transaction i.e. you cannot buy on the next day after you sell, you have to cooldown for a day
 * at-least before buying again. Note - There can be no overlapping transaction. One transaction
 * needs to be closed (a buy followed by a sell) before opening another transaction (another buy).
 *
 * <p>12 -> n {10, 15, 17, 20, 16, 18, 22, 20, 22, 20, 23, 25} output : 19
 */
public class BuySellStocksInfiniteTxnAllowedWithCoolDown {

  public static void main(String[] args) {
    System.out.println(
        BuySellStocksInfiniteTxnAllowedWithCoolDown.findAlt(
