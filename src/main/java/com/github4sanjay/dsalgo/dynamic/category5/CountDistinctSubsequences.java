 ...
 * <p>Examples:
 *
 * <p>Input : str = "gfg" Output : 7 The seven distinct subsequences are "", "g", "f", "gf", "fg",
 * "gg" and "gfg"
 *
 * <p>Input : str = "ggg" Output : 4 The four distinct subsequences are "", "g", "gg" and "ggg"
 */
public class CountDistinctSubsequences {
   ...
   * _________|___________|____________|______________|________________|________________|_____________________
   *
   * <p>If there are no repetitions, then count becomes double of count for n-1 because we get
   * count(n-1) more subsequences by adding current character at the end of all subsequences
   * possible with n-1 length. If there repetitions, then we find a count of all distinct
   * subsequences ending with the previous occurrence. This count can be obtained by recursively
   * calling for an index of the previous occurrence.
   *
