 ...
 * First compression -> The string should be compressed such that consecutive duplicates of
 * characters are replaced with a single character. For "aaabbccdee", the compressed string will be
 * "abcde". Second compression -> The string should be compressed such that consecutive duplicates
 * of characters are replaced with the character and followed by the number of consecutive
 * duplicates. For "aaabbccdee", the compressed string will be "a3b2c2de2".
 */
