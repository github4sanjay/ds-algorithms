...
/**
 * 1. You are given an array(arr) of integers. 2. You have to find the count of all subarrays with
 * sum 0.
 *
 * <p>15 -2 2 -8 1 7 10 23
 *
 * <p>Sample Output 3
 */
public class CountOfAllSubarraysWithZeroSum {
  ...
  public static void main(String[] args) {
    System.out.println(
        CountOfAllSubarraysWithZeroSum.find(new int[] {15, -2, 2, -8, 1, 7, 10, 23})); // 3
    System.out.println(
        CountOfAllSubarraysWithZeroSum.find(
            new int[] {2, 8, -3, -5, 2, -4, 6, 1, 2, 1, -3, 4})); // 6
  }
