...
/**
 * Given an unsorted array of integers, find the number of subarrays having sum exactly equal to a
 * given number k.
 *
 * <p>Examples:
 *
 * <p>Input : arr[] = {10, 2, -2, -20, 10}, k = -10 Output : 3 Subarrays: arr[0...3], arr[1...4],
 * arr[3..4] have sum exactly equal to -10.
 *
 * <p>Input : arr[] = {9, 4, 20, 3, 10, 5}, k = 33 Output : 2 Subarrays : arr[0...2], arr[2...4]
 * have sum exactly equal to 33.
 */
public class CountHavingSumEqualsToK {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        CountHavingSumEqualsToK.find(
            new int[] {3, 9, -2, 4, 1, -7, 2, 6, -5, 8, -3, -7, 6, 2, 1}, 5)); // 7
  }
