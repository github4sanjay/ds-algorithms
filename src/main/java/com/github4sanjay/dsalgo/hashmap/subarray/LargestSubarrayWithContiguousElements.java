 ...
 * that can be arranged in a continuous sequence. Examples:
 *
 * <p>Input: arr[] = {10, 12, 11}; Output: Length of the longest contiguous subarray is 3
 *
 * <p>Input: arr[] = {14, 12, 11, 20}; Output: Length of the longest contiguous subarray is 2
 *
 * <p>Input: arr[] = {1, 56, 58, 57, 90, 92, 94, 93, 91, 45}; Output: Length of the longest
 * contiguous subarray is 5
 */
public class LargestSubarrayWithContiguousElements {

  public static void main(String[] args) {
    System.out.println(
        LargestSubarrayWithContiguousElements.find(
            new int[] {1, 56, 58, 57, 90, 92, 94, 93, 91, 45}));
    ...
    System.out.println(
        LargestSubarrayWithContiguousElements.find(new int[] {1, 2, 2, 2, 5})); // 2 as duplicates
  }
