...
public class NextGreaterElementOnRight {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(NextGreaterElementOnRight.find(new int[]{13, 7, 6, 12})));  //   [-1, 12, 12, -1]
        System.out.println(Arrays.toString(NextGreaterElementOnRight.find(new int[]{4, 5, 2, 25})));   //   [5, 25, 25, -1]
        System.out.println(Arrays.toString(NextGreaterElementOnRight.find(new int[]{5, 3, 8, -2, 7}))); //   [8, 8, -1, 7, -1]
    }
