...
public class DuplicateBrackets {
     ...
     * 1. if character is not equal to ')' push in stack
     * 2. if character is ')'
     *     if peek character is '(' then return true as nothing was between opening and closing bracket
     *     if peek character is other than '(' then pop until opening bracket including opening bracket
     *
     */
