...
public class CheckIfAnArrayCanBeDividedIntoPairsWhoseSumIsDivisibleByK {
    public static void main(String[] args) {
        System.out.println(CheckIfAnArrayCanBeDividedIntoPairsWhoseSumIsDivisibleByK.check(new int[]{9,7,5,3}, 6));
        System.out.println(CheckIfAnArrayCanBeDividedIntoPairsWhoseSumIsDivisibleByK.check(new int[]{9,7,5,3,7}, 6));
    }
