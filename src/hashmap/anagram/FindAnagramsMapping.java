...
public class FindAnagramsMapping {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(FindAnagramsMapping.find(new int[]{12, 28, 46, 32, 50}, new int[]{50, 12, 32, 46, 28})));
        System.out.println(Arrays.toString(FindAnagramsMapping.find(new int[]{1, 2, 3, 4, 5}, new int[]{5, 4, 3, 2, 1})));
    }
