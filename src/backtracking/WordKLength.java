...
public class WordKLength {
    ...
    // combination
    private static void findAsCombination(String str, int k, int currentItemIndex, int placedSoFar, Character[] placed, Set<Character> alreadyUsed) {
    ...
    // permutation
    private static void findAsPermutation(String str, int k, int currentBox, Character[] placed, Set<Character> alreadyUsed) {
