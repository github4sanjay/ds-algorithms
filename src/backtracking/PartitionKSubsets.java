...
public class PartitionKSubsets {
    ...
    private static void partition(int n, int k, int index, List<List<Integer>> answer, int noOfPartition) {
        ...
        for (int i=0; i< answer.size(); i++){
            ...
            if (set.size() > 0){
                ...
                set.remove(set.size()-1);
                break; // only first non empty its necessary because {{1,3},{2},{}} is same as {{1,3},{},{2}}
            }
        }
