...
public class WordPatternMatching {
    ...
    private static void match(String currentPattern, String str, HashMap<Character, String> characterStringMap, String actualPattern) {
        ...
        } else { // if character already mapped only starting characters should be same as previous mapping
