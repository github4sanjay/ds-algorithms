...
public class CrossWordPuzzle {
    ...
    private static boolean[] placeWordInRow(char[][] crossword, String currentWord, int row, int col) {
    ...
    private static boolean[] placeWordInCol(char[][] crossword, String currentWord, int row, int col) {
        boolean[] placed = new boolean[currentWord.length()];
        char[] chars = currentWord.toCharArray();
