...
public class PrintPermutations {
    ...
    public static void main(String[] args) {
        ...
        //[1200, 1020, 1002, 2100, 0120, 0102, 2010, 0210, 0012, 2001, 0201, 0021, 1200, 1020, 1002, 2100, 0120, 0102,
        // 2010, 0210, 0012, 2001, 0201, 0021, 1200, 1020, 1002, 2100, 0120, 0102, 2010, 0210, 0012, 2001, 0201, 0021,
    ...
    public static void printWithCombinationTrick(int totalItems, int totalBox, int noOfSelected, int currentBox, String ans, boolean[] items){
        ...
        for (int i=0;i < totalItems; i++){
            if (!items[i]){
                items[i] = true;
                printWithCombinationTrick(totalItems, totalBox, noOfSelected + 1, currentBox+1, ans+(i+1), items);
                items[i] = false;
            }
        }
