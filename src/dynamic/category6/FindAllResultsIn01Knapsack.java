...
public class FindAllResultsIn01Knapsack {
    ...
    public static void main(String[] args) {
        // System.out.println(FindAllResultsIn01Knapsack.find(new int[]{15, 14, 10, 45, 30}, new int[]{2, 5, 1, 3, 4}, 7));
        System.out.println(FindAllResultsIn01Knapsack.find(new int[]{15, 14, 10, 45, 30, 75}, new int[]{2, 5, 1, 3, 4, 7}, 7));
    }
