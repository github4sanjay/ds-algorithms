...
public class LongestCommonSubsequence {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Length of LCS is" + " " + LongestCommonSubsequence.lcs( "AGGTAB", "GXTXAYB" ) );
    }
     ...
     * from 1,2,..n-1. Recall from theory of permutation and combination that number of combinations with 1 element are nC1.
