...
class AreTreesMirrorInShapeTest {
  ...
  public void test() {
    ...
    Assertions.assertFalse(AreTreesMirrorInShape.check(root1, root2));

    var root3 =
        GenericTreeUtil.createTree(new int[] {10, 20, -1, 30, 50, -1, 60, -1, -1, 40, -1, -1});
    Assertions.assertFalse(AreTreesMirrorInShape.check(root1, root3));

    var root4 =
        GenericTreeUtil.createTree(
            new int[] {100, 200, -1, 300, 500, -1, 600, -1, -1, 400, -1, -1});
    Assertions.assertTrue(AreTreesMirrorInShape.check(root4, root3));
  }
}
