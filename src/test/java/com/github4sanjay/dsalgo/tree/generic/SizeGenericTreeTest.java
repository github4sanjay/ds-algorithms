...
class SizeGenericTreeTest {

  @Test
  public void testSizeGenericTree() {
    var root =
        GenericTreeUtil.createTree(new int[] {10, 20, -1, 30, 50, -1, 60, -1, -1, 40, -1, -1});
    Assertions.assertEquals(6, SizeGenericTree.find(root));
    Assertions.assertEquals(6, SizeGenericTree.findRecursion(root));
  }
}
