 ...
 *
 * There are two singly linked lists in a system. By some programming error, t
 * he end node of one of the linked list got linked to the second list, forming an inverted Y shaped list.
 *
...
public class IntersectionOfTwoLinkedList {
    ...
    /**
     * Traverse both head till end put its elements in two stacks
     * then start popping from stack and compare if they equal save it in previous
     * if they not equal return previous
     */
