...
public class LinkedListUtil {
    ...
    public static <T extends Comparable<T>> LinkedList<T> mergeSorted(LinkNode<T> head1, LinkNode<T> head2) {
    ...
    private static <T extends Comparable<T>> LinkedList<T> mergeSort(LinkNode<T> head, LinkNode<T> tail) {
        if (head == tail){
            var newLinkedList = new LinkedList<T>();
    ...
    public static <T extends Comparable<T>> LinkedList<T> removeDuplicatesCreatingNewLinkedList(LinkNode<T> head) {
        var newLinkedList = new LinkedList<T>();
        var currentNode = head;
