...
public class RemoveLeaves {
    ...
    public static void main(String[] args) {
        var root1 = BinaryTreeUtil.create(new int[]{50, 25, 12, -1, -1, 37, 30, -1, -1, -1, 75, 62, -1, 70, -1, -1, 87, -1, -1});
        RemoveLeaves.recursive(root1);
        AlgoUtil.print(BinaryTreeUtil.display(root1));

        var root2 = BinaryTreeUtil.create(new int[]{50, 25, 12, -1, -1, 37, 30, -1, -1, -1, 75, 62, -1, 70, -1, -1, 87, -1, -1});
