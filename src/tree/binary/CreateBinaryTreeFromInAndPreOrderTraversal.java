...
public class CreateBinaryTreeFromInAndPreOrderTraversal {
    ...
    public static void main(String[] args) {
        ...
        var answer1 = TraversalBinaryTree.recursive(
                buildTree(answer.getInorder().toArray(Integer[]::new), answer.getPreorder().toArray(Integer[]::new)));
    ...
    public static BinaryNode buildUtil(Integer[] in, Integer[] pre, int inStrt, int inEnd, Index pIndex) {
        if (inStrt > inEnd)
            return null;
