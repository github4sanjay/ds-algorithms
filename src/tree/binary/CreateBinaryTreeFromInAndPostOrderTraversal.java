...
public class CreateBinaryTreeFromInAndPostOrderTraversal {
    ...
    public static void main(String[] args) {
        ...
        var answer1 = TraversalBinaryTree.recursive(
                buildTree(answer.getInorder().toArray(Integer[]::new), answer.getPostorder().toArray(Integer[]::new)));
    ...
    public static BinaryNode buildUtil(Integer[] in, Integer[] post, int inStrt, int inEnd, Index pIndex) {
        if (inStrt > inEnd)
            return null;
