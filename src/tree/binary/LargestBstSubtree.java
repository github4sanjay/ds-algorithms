...
public class LargestBstSubtree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Node containing largest BST : " + answer.node.getData() +" and number of nodes : " + answer.noOfNodes);
        ...
        System.out.println("Node containing largest BST : " + answer1.node.getData() +" and number of nodes : " + answer1.noOfNodes);
