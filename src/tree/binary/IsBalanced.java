...
/**
 * You are required to check if the tree is balanced.
...
public class IsBalanced {
    ...
    private static Answer recursive(BinaryNode root) {
        ...
        var answer = new Answer();
        answer.isBalanced = leftAnswer.isBalanced && rightAnswer.isBalanced && Math.abs(leftAnswer.height - rightAnswer.height) <= 1;
